 ...
 *
 * In git, a given sha (or branch) can be behind or ahead of any other sha; it is also possible for a sha to be both behind **and** ahead of another sha, if they both have commits the other is missing.
 *
 * We care about whether the head sha is ahead of the base sha, i.e. head has commits base doesn't have, and we care about whether the head sha is not behind the base sha, i.e. head has all of the commits base has.
 */
